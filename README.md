...
```
## ArgoCD
Please clone [the application manifest repository](https://github.com/seifrajhi/ci-cd-demo-manifests) first. This repo holds the application manifests and will be synced with ArgoCD later. The manifests are maintained by [Kustomize](https://github.com/kubernetes-sigs/kustomize), which is supported by ArgoCD out-of-the-box. 
